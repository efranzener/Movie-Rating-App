...
const SignUp = () => {
    ...
    const handleSubmit = async (e) =>  {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                setErrMsg("Cannot create an account with that email, please try again with a different email address.")
    ...
    return(
        <>
        {successMsg ? (
            <p className="successAlert">Account successfully created. Please log in</p>
        ) : (
            ...
            <form onSubmit={handleSubmit} id="signupForm">
                ...
                <label htmlFor="pwd">
                    ...
                    <p id="pwdnote" className={pwdFocus && !validPwd ? "instructions" : "offscreen"}>
                        <FontAwesomeIcon icon={faCircleInfo}/>
                        8-20 characters <br/>
                        Must include an uppercase and lowercase letter, a number and a special character.<br/>
